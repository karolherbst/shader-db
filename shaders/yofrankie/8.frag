...
varying vec3 var1;
const vec3 cons22 = vec3(0.800000, 0.800000, 1.000000);
const vec3 cons25 = vec3(2.000000, 0.400000, 0.000000);
uniform sampler2D samp1;
const float cons32 = float(0.600000);
const float cons33 = float(1.000000);
const vec3 cons39 = vec3(0.612224, 0.866702, 1.000000);
uniform vec3 unf46;
const float cons57 = float(0.300000);
uniform vec4 unf60;
uniform sampler1D samp2;
const float cons73 = float(0.900000);
const float cons86 = float(0.569875);
const float cons87 = float(84.000000);
uniform vec3 unf91;
const vec3 cons92 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf97;
const float cons106 = float(0.300000);
uniform vec4 unf109;
uniform sampler1D samp3;
const float cons122 = float(0.900000);
const float cons135 = float(84.000000);
const float cons137 = float(1.000000);
const float cons138 = float(0.569875);
uniform vec3 unf143;
const vec3 cons144 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf150;
const float cons154 = float(20.000000);
uniform vec3 unf157;
const float cons160 = float(0.996195);
const float cons161 = float(0.000571);
const float cons172 = float(0.300000);
uniform sampler2DShadow samp4;
uniform mat4 unf176;
const float cons177 = float(0.005000);
uniform float unf182;
uniform vec3 unf189;
const float cons193 = float(20.000000);
uniform vec3 unf196;
const float cons199 = float(0.996195);
const float cons200 = float(0.000571);
const float cons211 = float(0.300000);
uniform sampler2DShadow samp5;
uniform mat4 unf215;
const float cons216 = float(0.005000);
uniform float unf221;
const float cons231 = float(0.700000);
const float cons234 = float(6.000000);
const float cons235 = float(26.000000);
const float cons236 = float(0.000000);
const float cons237 = float(0.000000);
const vec4 cons241 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	mtex_nspace_tangent(var1, tmp2, tmp11, tmp15);
	texco_refl(tmp15, tmp4, tmp18);
	mtex_2d_mapping(tmp18, tmp20);
	mtex_mapping_size(tmp20, cons22, tmp23);
	mtex_mapping_ofs(tmp23, cons25, tmp26);
	mtex_image(tmp26, samp1, tmp29, tmp30, tmp31);
	math_multiply(cons32, cons33, tmp34);
	set_rgba(tmp30, tmp36);
	mtex_alpha_from_col(tmp30, tmp38);
	mtex_rgb_blend(cons39, tmp36.rgb, tmp38, tmp34, tmp43);
	set_rgb_zero(tmp44);
	set_rgb_zero(tmp45);
	lamp_visibility_sun_hemi(unf46, tmp47, tmp48, tmp49);
	shade_inp(tmp15, tmp47, tmp52);
	shade_is_hemi(tmp52, tmp54);
	shade_visifac(tmp54, tmp49, cons57, tmp58);
	shade_mul_value(tmp58, unf60, tmp61);
	vec_math_dot(tmp4, tmp15, tmp64, tmp65);
	valtorgb(tmp65, samp2, tmp68, tmp69);
	mtex_alpha_from_col(tmp68, tmp71);
	math_multiply(tmp71, cons73, tmp74);
	mix_add(tmp74, vec4(tmp43, 1.0), tmp68, tmp78);
	shade_madd(vec4(tmp44, 1.0), tmp61, tmp78, tmp82);
	shade_hemi_spec(tmp15, tmp47, tmp4, cons86, cons87, tmp49, tmp89);
	shade_add_spec(tmp89, unf91, cons92, tmp93);
	shade_add(vec4(tmp45, 1.0), vec4(tmp93, 1.0), tmp96);
	lamp_visibility_sun_hemi(unf97, tmp98, tmp99, tmp100);
	shade_inp(tmp15, tmp98, tmp103);
	shade_visifac(tmp103, tmp100, cons106, tmp107);
	shade_mul_value(tmp107, unf109, tmp110);
	vec_math_dot(tmp4, tmp15, tmp113, tmp114);
	valtorgb(tmp114, samp3, tmp117, tmp118);
	mtex_alpha_from_col(tmp117, tmp120);
	math_multiply(tmp120, cons122, tmp123);
	mix_add(tmp123, vec4(tmp43, 1.0), tmp117, tmp127);
	shade_madd(tmp82, tmp110, tmp127, tmp131);
	shade_phong_spec(tmp15, tmp98, tmp4, cons135, tmp136);
	shade_spec_t(cons137, cons138, tmp100, tmp136, tmp141);
	shade_add_spec(tmp141, unf143, cons144, tmp145);
	shade_add(tmp96, vec4(tmp145, 1.0), tmp148);
	lamp_visibility_other(varposition, unf150, tmp151, tmp152, tmp153);
	lamp_falloff_invlinear(cons154, tmp152, tmp156);
	lamp_visibility_spot_circle(unf157, tmp151, tmp159);
	lamp_visibility_spot(cons160, cons161, tmp159, tmp156, tmp164);
	lamp_visibility_clamp(tmp164, tmp166);
	shade_inp(tmp15, tmp151, tmp169);
	shade_visifac(tmp169, tmp166, cons172, tmp173);
	test_shadowbuf(varposition, samp4, unf176, cons177, tmp169, tmp179);
	shade_only_shadow(tmp173, tmp179, unf182, tmp183);
	shade_only_shadow_diffuse(tmp183, tmp43, tmp131, tmp187);
	lamp_visibility_other(varposition, unf189, tmp190, tmp191, tmp192);
	lamp_falloff_invlinear(cons193, tmp191, tmp195);
	lamp_visibility_spot_circle(unf196, tmp190, tmp198);
	lamp_visibility_spot(cons199, cons200, tmp198, tmp195, tmp203);
	lamp_visibility_clamp(tmp203, tmp205);
	shade_inp(tmp15, tmp190, tmp208);
	shade_visifac(tmp208, tmp205, cons211, tmp212);
	test_shadowbuf(varposition, samp5, unf215, cons216, tmp208, tmp218);
	shade_only_shadow(tmp212, tmp218, unf221, tmp222);
	shade_only_shadow_diffuse(tmp222, tmp43, tmp187, tmp226);
	shade_add(tmp226, tmp148, tmp229);
	mtex_alpha_to_col(tmp229, cons231, tmp232);
	shade_mist_factor(varposition, cons234, cons235, cons236, cons237, tmp238);
	mix_blend(tmp238, tmp232, cons241, tmp242);
