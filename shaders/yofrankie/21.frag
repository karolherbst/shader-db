...
uniform vec4 unf21;
const vec4 cons25 = vec4(1.000000, 1.000000, 1.000000, 0.000000);
const float cons30 = float(2.000000);
const float cons31 = float(28.000000);
uniform vec3 unf35;
const vec3 cons36 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf41;
const float cons50 = float(1.000000);
uniform vec4 unf53;
const vec4 cons57 = vec4(1.000000, 1.000000, 1.000000, 0.000000);
const float cons62 = float(28.000000);
const float cons64 = float(1.000000);
const float cons65 = float(2.000000);
uniform vec3 unf70;
...
const float cons99 = float(1.000000);
uniform sampler2DShadow samp0;
uniform mat4 unf103;
const float cons104 = float(0.005000);
uniform float unf109;
const vec3 cons112 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf116;
...
const float cons164 = float(6.000000);
const float cons165 = float(26.000000);
const float cons166 = float(0.000000);
const float cons167 = float(0.000000);
const vec4 cons171 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	shade_phong_spec(tmp2, tmp42, tmp4, cons62, tmp63);
	...
	shade_obcolor(tmp159, unfobcolor, tmp162);
	shade_mist_factor(varposition, cons164, cons165, cons166, cons167, tmp168);
	mix_blend(tmp168, tmp162, cons171, tmp172);
	shade_alpha_opaque(tmp172, tmp174);
	shade_alpha_obcolor(tmp174, unfobcolor, tmp177);
