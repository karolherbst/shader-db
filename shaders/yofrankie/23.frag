...
const vec3 cons15 = vec3(1.000000, 0.729412, 0.490196);
const float cons18 = float(1.000000);
uniform sampler2D samp1;
varying vec3 var1;
uniform sampler2D samp2;
const float cons44 = float(0.200000);
const float cons45 = float(1.000000);
const vec3 cons48 = vec3(1.000000, 1.000000, 1.000000);
const float cons52 = float(0.396068);
const float cons53 = float(1.000000);
const float cons55 = float(1.000000);
const float cons56 = float(0.000000);
const float cons60 = float(0.200000);
uniform vec3 unf63;
uniform vec4 unf79;
uniform sampler1D samp3;
const float cons92 = float(1.000000);
uniform vec3 unf102;
uniform vec4 unf116;
uniform sampler1D samp4;
const float cons129 = float(1.000000);
uniform vec3 unf140;
const float cons144 = float(20.000000);
uniform vec3 unf147;
const float cons150 = float(0.996195);
const float cons151 = float(0.000571);
uniform sampler2DShadow samp5;
uniform mat4 unf168;
const float cons169 = float(0.005000);
uniform float unf174;
uniform vec3 unf181;
...
uniform mat4 unf209;
const float cons210 = float(0.005000);
uniform float unf215;
...
void main(void)
{
	...
	vec_math_negate(tmp30, tmp32);
	mtex_2d_mapping(tmp32, tmp34);
	mtex_image(tmp34, samp2, tmp37, tmp38, tmp39);
	mtex_rgbtoint(tmp38, tmp41);
	mtex_value_invert(tmp41, tmp43);
	math_multiply(cons44, cons45, tmp46);
	mtex_rgb_add(tmp19, cons48, tmp43, tmp46, tmp51);
	mtex_value_add(cons52, cons53, tmp43, cons55, cons56, tmp57);
	mtex_value_clamp_positive(tmp57, tmp59);
	shade_mul_value(cons60, vec4(tmp51, 1.0), tmp62);
	lamp_visibility_sun_hemi(unf63, tmp64, tmp65, tmp66);
	shade_inp(tmp30, tmp64, tmp69);
	shade_is_hemi(tmp69, tmp71);
	shade_cubic(tmp71, tmp73);
	shade_visifac(tmp73, tmp66, tmp59, tmp77);
	shade_mul_value(tmp77, unf79, tmp80);
	vec_math_dot(tmp4, tmp30, tmp83, tmp84);
	valtorgb(tmp84, samp3, tmp87, tmp88);
	mtex_alpha_from_col(tmp87, tmp90);
	math_multiply(tmp90, cons92, tmp93);
	mix_overlay(tmp93, vec4(tmp51, 1.0), tmp87, tmp97);
	shade_madd(tmp62, tmp80, tmp97, tmp101);
	lamp_visibility_sun_hemi(unf102, tmp103, tmp104, tmp105);
	shade_inp(tmp30, tmp103, tmp108);
	shade_cubic(tmp108, tmp110);
	shade_visifac(tmp110, tmp105, tmp59, tmp114);
	shade_mul_value(tmp114, unf116, tmp117);
	vec_math_dot(tmp4, tmp30, tmp120, tmp121);
	valtorgb(tmp121, samp4, tmp124, tmp125);
	mtex_alpha_from_col(tmp124, tmp127);
	math_multiply(tmp127, cons129, tmp130);
	mix_overlay(tmp130, vec4(tmp51, 1.0), tmp124, tmp134);
	shade_madd(tmp101, tmp117, tmp134, tmp138);
	lamp_visibility_other(varposition, unf140, tmp141, tmp142, tmp143);
	lamp_falloff_invlinear(cons144, tmp142, tmp146);
	lamp_visibility_spot_circle(unf147, tmp141, tmp149);
	lamp_visibility_spot(cons150, cons151, tmp149, tmp146, tmp154);
	lamp_visibility_clamp(tmp154, tmp156);
	shade_inp(tmp30, tmp141, tmp159);
	shade_cubic(tmp159, tmp161);
	shade_visifac(tmp161, tmp156, tmp59, tmp165);
	test_shadowbuf(varposition, samp5, unf168, cons169, tmp159, tmp171);
	shade_only_shadow(tmp165, tmp171, unf174, tmp175);
	shade_only_shadow_diffuse(tmp175, tmp51, tmp138, tmp179);
	...
	shade_inp(tmp30, tmp182, tmp200);
	shade_cubic(tmp200, tmp202);
	shade_visifac(tmp202, tmp197, tmp59, tmp206);
	test_shadowbuf(varposition, samp6, unf209, cons210, tmp200, tmp212);
	shade_only_shadow(tmp206, tmp212, unf215, tmp216);
	shade_only_shadow_diffuse(tmp216, tmp51, tmp179, tmp220);
