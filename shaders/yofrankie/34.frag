...
uniform vec3 unf21;
const float cons32 = float(0.800000);
uniform vec4 unf35;
uniform sampler1D samp1;
const float cons48 = float(0.900000);
uniform vec3 unf58;
const float cons67 = float(0.800000);
uniform vec4 unf70;
uniform sampler1D samp2;
const float cons83 = float(0.900000);
uniform vec3 unf94;
const float cons98 = float(20.000000);
uniform vec3 unf101;
const float cons104 = float(0.996195);
const float cons105 = float(0.000571);
const float cons116 = float(0.800000);
uniform sampler2DShadow samp3;
uniform mat4 unf120;
const float cons121 = float(0.005000);
uniform float unf126;
uniform vec3 unf133;
const float cons137 = float(20.000000);
uniform vec3 unf140;
const float cons143 = float(0.996195);
const float cons144 = float(0.000571);
const float cons155 = float(0.800000);
uniform sampler2DShadow samp4;
uniform mat4 unf159;
const float cons160 = float(0.005000);
uniform float unf165;
const float cons172 = float(1.000000);
const float cons175 = float(6.000000);
const float cons176 = float(26.000000);
const float cons177 = float(0.000000);
const float cons178 = float(0.000000);
const vec4 cons182 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	shade_is_hemi(tmp27, tmp29);
	shade_visifac(tmp29, tmp24, cons32, tmp33);
	shade_mul_value(tmp33, unf35, tmp36);
	vec_math_dot(tmp4, tmp2, tmp39, tmp40);
	valtorgb(tmp40, samp1, tmp43, tmp44);
	mtex_alpha_from_col(tmp43, tmp46);
	math_multiply(tmp46, cons48, tmp49);
	mix_overlay(tmp49, vec4(tmp19, 1.0), tmp43, tmp53);
	shade_madd(vec4(tmp20, 1.0), tmp36, tmp53, tmp57);
	lamp_visibility_sun_hemi(unf58, tmp59, tmp60, tmp61);
	shade_inp(tmp2, tmp59, tmp64);
	shade_visifac(tmp64, tmp61, cons67, tmp68);
	shade_mul_value(tmp68, unf70, tmp71);
	vec_math_dot(tmp4, tmp2, tmp74, tmp75);
	valtorgb(tmp75, samp2, tmp78, tmp79);
	mtex_alpha_from_col(tmp78, tmp81);
	math_multiply(tmp81, cons83, tmp84);
	mix_overlay(tmp84, vec4(tmp19, 1.0), tmp78, tmp88);
	shade_madd(tmp57, tmp71, tmp88, tmp92);
	lamp_visibility_other(varposition, unf94, tmp95, tmp96, tmp97);
	lamp_falloff_invlinear(cons98, tmp96, tmp100);
	lamp_visibility_spot_circle(unf101, tmp95, tmp103);
	lamp_visibility_spot(cons104, cons105, tmp103, tmp100, tmp108);
	lamp_visibility_clamp(tmp108, tmp110);
	shade_inp(tmp2, tmp95, tmp113);
	shade_visifac(tmp113, tmp110, cons116, tmp117);
	test_shadowbuf(varposition, samp3, unf120, cons121, tmp113, tmp123);
	shade_only_shadow(tmp117, tmp123, unf126, tmp127);
	shade_only_shadow_diffuse(tmp127, tmp19, tmp92, tmp131);
	...
	shade_only_shadow_diffuse(tmp166, tmp19, tmp131, tmp170);
	mtex_alpha_to_col(tmp170, cons172, tmp173);
	shade_mist_factor(varposition, cons175, cons176, cons177, cons178, tmp179);
	mix_blend(tmp179, tmp173, cons182, tmp183);
	shade_alpha_opaque(tmp183, tmp185);
