...
const float cons40 = float(0.200000);
const float cons41 = float(1.000000);
const float cons43 = float(0.100000);
const float cons44 = float(1.000000);
const float cons47 = float(0.000000);
uniform vec3 unf53;
const float cons64 = float(0.784028);
uniform vec4 unf67;
uniform sampler1D samp3;
const float cons80 = float(0.300000);
const float cons93 = float(0.100000);
const float cons94 = float(16.000000);
uniform vec3 unf98;
const vec3 cons99 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf104;
const float cons113 = float(0.784028);
uniform vec4 unf116;
uniform sampler1D samp4;
const float cons129 = float(0.300000);
const float cons142 = float(16.000000);
...
const float cons179 = float(0.784028);
...
const float cons218 = float(0.784028);
...
void main(void)
{
	...
	texco_uv(var0, tmp32);
	mtex_image(tmp32, samp2, tmp35, tmp36, tmp37);
	mtex_rgbtoint(tmp36, tmp39);
	math_multiply(cons40, cons41, tmp42);
	mtex_value_blend(cons43, cons44, tmp39, tmp42, cons47, tmp48);
	mtex_value_clamp_positive(tmp48, tmp50);
	set_rgb_zero(tmp51);
	set_rgb_zero(tmp52);
	lamp_visibility_sun_hemi(unf53, tmp54, tmp55, tmp56);
	shade_inp(tmp30, tmp54, tmp59);
	shade_is_hemi(tmp59, tmp61);
	shade_visifac(tmp61, tmp56, cons64, tmp65);
	shade_mul_value(tmp65, unf67, tmp68);
	vec_math_dot(tmp4, tmp30, tmp71, tmp72);
	valtorgb(tmp72, samp3, tmp75, tmp76);
	mtex_alpha_from_col(tmp75, tmp78);
	math_multiply(tmp78, cons80, tmp81);
	mix_add(tmp81, vec4(tmp19, 1.0), tmp75, tmp85);
	shade_madd(vec4(tmp51, 1.0), tmp68, tmp85, tmp89);
	shade_hemi_spec(tmp30, tmp54, tmp4, cons93, cons94, tmp56, tmp96);
	...
	mix_add(tmp130, vec4(tmp19, 1.0), tmp124, tmp134);
	shade_madd(tmp89, tmp117, tmp134, tmp138);
	shade_phong_spec(tmp30, tmp105, tmp4, cons142, tmp143);
	shade_spec_t(cons144, tmp50, tmp107, tmp143, tmp148);
	...
	shade_only_shadow_diffuse(tmp190, tmp19, tmp138, tmp194);
	...
	shade_only_shadow_diffuse(tmp229, tmp19, tmp194, tmp233);
