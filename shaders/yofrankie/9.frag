...
const float cons8 = float(0.873944);
...
void main(void)
{
	...
	math_multiply(cons8, cons9, tmp10);
	set_rgba(tmp6, tmp12);
	mtex_alpha_from_col(tmp6, tmp14);
	mtex_rgb_blend(cons15, tmp12.rgb, tmp14, tmp10, tmp19);
	mtex_alpha_to_col(vec4(tmp19, 1.0), cons21, tmp22);
	shade_alpha_opaque(tmp22, tmp24);
