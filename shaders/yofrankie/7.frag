...
const vec3 cons10 = vec3(1.000000, 1.000000, 1.000000);
const float cons12 = float(1.000000);
...
const float cons32 = float(6.000000);
const float cons33 = float(26.000000);
const float cons34 = float(0.000000);
const float cons35 = float(0.000000);
const vec4 cons39 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	set_rgba(tmp6, tmp9);
	mtex_rgb_dark(cons10, tmp9.rgb, cons12, cons13, tmp14);
	mtex_alpha_from_col(tmp6, tmp16);
	mtex_value_dark(cons17, cons18, tmp16, cons20, cons21, tmp22);
	mtex_value_clamp(tmp22, tmp24);
	mtex_alpha_to_col(vec4(tmp14, 1.0), tmp24, tmp27);
	shade_obcolor(tmp27, unfobcolor, tmp30);
	shade_mist_factor(varposition, cons32, cons33, cons34, cons35, tmp36);
	mix_blend(tmp36, tmp30, cons39, tmp40);
	shade_alpha_obcolor(tmp40, unfobcolor, tmp43);
