...
varying vec3 var1;
const float cons31 = float(0.500000);
uniform vec3 unf37;
const float cons50 = float(0.798689);
uniform vec4 unf53;
uniform sampler1D samp2;
const float cons66 = float(1.000000);
const float cons79 = float(0.700000);
const float cons80 = float(50.000000);
uniform vec3 unf84;
const vec3 cons85 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf90;
const float cons101 = float(0.798689);
uniform vec4 unf104;
uniform sampler1D samp3;
const float cons117 = float(1.000000);
const float cons130 = float(50.000000);
const float cons132 = float(1.000000);
const float cons133 = float(0.700000);
uniform vec3 unf138;
const vec3 cons139 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf145;
const float cons149 = float(20.000000);
uniform vec3 unf152;
const float cons155 = float(0.996195);
const float cons156 = float(0.000571);
const float cons169 = float(0.798689);
uniform sampler2DShadow samp4;
uniform mat4 unf173;
const float cons174 = float(0.005000);
uniform float unf179;
uniform vec3 unf186;
const float cons190 = float(20.000000);
uniform vec3 unf193;
const float cons196 = float(0.996195);
const float cons197 = float(0.000571);
const float cons210 = float(0.798689);
...
const float cons236 = float(6.000000);
const float cons237 = float(26.000000);
const float cons238 = float(0.000000);
const float cons239 = float(0.000000);
const vec4 cons243 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	mtex_blend_normal(cons31, tmp2, tmp30, tmp34);
	set_rgb_zero(tmp35);
	set_rgb_zero(tmp36);
	lamp_visibility_sun_hemi(unf37, tmp38, tmp39, tmp40);
	shade_inp(tmp34, tmp38, tmp43);
	shade_is_hemi(tmp43, tmp45);
	shade_cubic(tmp45, tmp47);
	shade_visifac(tmp47, tmp40, cons50, tmp51);
	shade_mul_value(tmp51, unf53, tmp54);
	vec_math_dot(tmp4, tmp34, tmp57, tmp58);
	valtorgb(tmp58, samp2, tmp61, tmp62);
	mtex_alpha_from_col(tmp61, tmp64);
	math_multiply(tmp64, cons66, tmp67);
	mix_add(tmp67, vec4(tmp19, 1.0), tmp61, tmp71);
	shade_madd(vec4(tmp35, 1.0), tmp54, tmp71, tmp75);
	shade_hemi_spec(tmp34, tmp38, tmp4, cons79, cons80, tmp40, tmp82);
	shade_add_spec(tmp82, unf84, cons85, tmp86);
	shade_add(vec4(tmp36, 1.0), vec4(tmp86, 1.0), tmp89);
	lamp_visibility_sun_hemi(unf90, tmp91, tmp92, tmp93);
	shade_inp(tmp34, tmp91, tmp96);
	shade_cubic(tmp96, tmp98);
	shade_visifac(tmp98, tmp93, cons101, tmp102);
	shade_mul_value(tmp102, unf104, tmp105);
	vec_math_dot(tmp4, tmp34, tmp108, tmp109);
	valtorgb(tmp109, samp3, tmp112, tmp113);
	mtex_alpha_from_col(tmp112, tmp115);
	math_multiply(tmp115, cons117, tmp118);
	mix_add(tmp118, vec4(tmp19, 1.0), tmp112, tmp122);
	shade_madd(tmp75, tmp105, tmp122, tmp126);
	shade_phong_spec(tmp34, tmp91, tmp4, cons130, tmp131);
	shade_spec_t(cons132, cons133, tmp93, tmp131, tmp136);
	shade_add_spec(tmp136, unf138, cons139, tmp140);
	shade_add(tmp89, vec4(tmp140, 1.0), tmp143);
	lamp_visibility_other(varposition, unf145, tmp146, tmp147, tmp148);
	lamp_falloff_invlinear(cons149, tmp147, tmp151);
	lamp_visibility_spot_circle(unf152, tmp146, tmp154);
	lamp_visibility_spot(cons155, cons156, tmp154, tmp151, tmp159);
	lamp_visibility_clamp(tmp159, tmp161);
	shade_inp(tmp34, tmp146, tmp164);
	shade_cubic(tmp164, tmp166);
	shade_visifac(tmp166, tmp161, cons169, tmp170);
	test_shadowbuf(varposition, samp4, unf173, cons174, tmp164, tmp176);
	shade_only_shadow(tmp170, tmp176, unf179, tmp180);
	shade_only_shadow_diffuse(tmp180, tmp19, tmp126, tmp184);
	lamp_visibility_other(varposition, unf186, tmp187, tmp188, tmp189);
	lamp_falloff_invlinear(cons190, tmp188, tmp192);
	lamp_visibility_spot_circle(unf193, tmp187, tmp195);
	lamp_visibility_spot(cons196, cons197, tmp195, tmp192, tmp200);
	lamp_visibility_clamp(tmp200, tmp202);
	shade_inp(tmp34, tmp187, tmp205);
	shade_cubic(tmp205, tmp207);
	shade_visifac(tmp207, tmp202, cons210, tmp211);
	test_shadowbuf(varposition, samp5, unf214, cons215, tmp205, tmp217);
	shade_only_shadow(tmp211, tmp217, unf220, tmp221);
	shade_only_shadow_diffuse(tmp221, tmp19, tmp184, tmp225);
	shade_add(tmp225, tmp143, tmp228);
	mtex_alpha_to_col(tmp228, cons230, tmp231);
	shade_obcolor(tmp231, unfobcolor, tmp234);
	shade_mist_factor(varposition, cons236, cons237, cons238, cons239, tmp240);
	mix_blend(tmp240, tmp234, cons243, tmp244);
	shade_alpha_opaque(tmp244, tmp246);
	shade_alpha_obcolor(tmp246, unfobcolor, tmp249);
