...
const vec3 cons12 = vec3(0.800000, 0.800000, 0.800000);
const float cons14 = float(1.000000);
...
const float cons27 = float(0.250000);
uniform vec3 unf30;
const float cons41 = float(0.827261);
uniform vec4 unf44;
uniform vec3 unf50;
const float cons59 = float(0.827261);
uniform vec4 unf62;
varying vec3 varposition;
uniform vec3 unf69;
const float cons73 = float(20.000000);
uniform vec3 unf76;
const float cons79 = float(0.996195);
const float cons80 = float(0.000571);
const float cons91 = float(0.827261);
uniform sampler2DShadow samp1;
uniform mat4 unf95;
const float cons96 = float(0.005000);
uniform float unf101;
uniform vec3 unf108;
const float cons112 = float(20.000000);
uniform vec3 unf115;
const float cons118 = float(0.996195);
const float cons119 = float(0.000571);
const float cons130 = float(0.827261);
uniform sampler2DShadow samp2;
uniform mat4 unf134;
const float cons135 = float(0.005000);
uniform float unf140;
const float cons150 = float(6.000000);
const float cons151 = float(26.000000);
const float cons152 = float(0.000000);
const float cons153 = float(0.000000);
const vec4 cons157 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	texco_uv(var0, tmp4);
	mtex_image(tmp4, samp0, tmp7, tmp8, tmp9);
	set_rgba(tmp8, tmp11);
	mtex_rgb_blend(cons12, tmp11.rgb, cons14, cons15, tmp16);
	mtex_alpha_from_col(tmp8, tmp18);
	mtex_value_blend(cons19, cons20, tmp18, cons22, cons23, tmp24);
	mtex_value_clamp(tmp24, tmp26);
	shade_mul_value(cons27, vec4(tmp16, 1.0), tmp29);
	lamp_visibility_sun_hemi(unf30, tmp31, tmp32, tmp33);
	shade_inp(tmp2, tmp31, tmp36);
	shade_is_hemi(tmp36, tmp38);
	shade_visifac(tmp38, tmp33, cons41, tmp42);
	shade_mul_value(tmp42, unf44, tmp45);
	shade_madd(tmp29, tmp45, vec4(tmp16, 1.0), tmp49);
	lamp_visibility_sun_hemi(unf50, tmp51, tmp52, tmp53);
	shade_inp(tmp2, tmp51, tmp56);
	shade_visifac(tmp56, tmp53, cons59, tmp60);
	shade_mul_value(tmp60, unf62, tmp63);
	shade_madd(tmp49, tmp63, vec4(tmp16, 1.0), tmp67);
	lamp_visibility_other(varposition, unf69, tmp70, tmp71, tmp72);
	lamp_falloff_invlinear(cons73, tmp71, tmp75);
	lamp_visibility_spot_circle(unf76, tmp70, tmp78);
	lamp_visibility_spot(cons79, cons80, tmp78, tmp75, tmp83);
	lamp_visibility_clamp(tmp83, tmp85);
	shade_inp(tmp2, tmp70, tmp88);
	shade_visifac(tmp88, tmp85, cons91, tmp92);
	test_shadowbuf(varposition, samp1, unf95, cons96, tmp88, tmp98);
	shade_only_shadow(tmp92, tmp98, unf101, tmp102);
	shade_only_shadow_diffuse(tmp102, tmp16, tmp67, tmp106);
	lamp_visibility_other(varposition, unf108, tmp109, tmp110, tmp111);
	lamp_falloff_invlinear(cons112, tmp110, tmp114);
	lamp_visibility_spot_circle(unf115, tmp109, tmp117);
	lamp_visibility_spot(cons118, cons119, tmp117, tmp114, tmp122);
	lamp_visibility_clamp(tmp122, tmp124);
	shade_inp(tmp2, tmp109, tmp127);
	shade_visifac(tmp127, tmp124, cons130, tmp131);
	test_shadowbuf(varposition, samp2, unf134, cons135, tmp127, tmp137);
	shade_only_shadow(tmp131, tmp137, unf140, tmp141);
	shade_only_shadow_diffuse(tmp141, tmp16, tmp106, tmp145);
	mtex_alpha_to_col(tmp145, tmp26, tmp148);
	shade_mist_factor(varposition, cons150, cons151, cons152, cons153, tmp154);
	mix_blend(tmp154, tmp148, cons157, tmp158);
