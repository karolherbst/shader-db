...
const float cons77 = float(0.050000);
const float cons78 = float(20.000000);
uniform vec3 unf82;
const vec3 cons83 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf88;
const float cons97 = float(1.000000);
uniform vec4 unf100;
uniform sampler1D samp3;
const float cons113 = float(1.000000);
const float cons126 = float(20.000000);
const float cons128 = float(1.000000);
const float cons129 = float(0.050000);
uniform vec3 unf134;
...
const float cons163 = float(1.000000);
...
const float cons202 = float(1.000000);
uniform sampler2DShadow samp5;
uniform mat4 unf206;
const float cons207 = float(0.005000);
uniform float unf212;
const float cons222 = float(1.000000);
const float cons225 = float(6.000000);
const float cons226 = float(26.000000);
const float cons227 = float(0.000000);
const float cons228 = float(0.000000);
const vec4 cons232 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	vec_math_dot(tmp4, tmp34, tmp55, tmp56);
	valtorgb(tmp56, samp2, tmp59, tmp60);
	mtex_alpha_from_col(tmp59, tmp62);
	math_multiply(tmp62, cons64, tmp65);
	mix_overlay(tmp65, vec4(tmp19, 1.0), tmp59, tmp69);
	shade_madd(vec4(tmp35, 1.0), tmp52, tmp69, tmp73);
	shade_hemi_spec(tmp34, tmp38, tmp4, cons77, cons78, tmp40, tmp80);
	...
	shade_mist_factor(varposition, cons225, cons226, cons227, cons228, tmp229);
	mix_blend(tmp229, tmp223, cons232, tmp233);
	shade_alpha_opaque(tmp233, tmp235);
