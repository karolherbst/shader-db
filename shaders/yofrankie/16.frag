...
const float cons14 = float(0.000000);
...
const float cons38 = float(0.200000);
uniform vec3 unf41;
const float cons52 = float(0.950000);
uniform vec4 unf55;
uniform vec3 unf61;
const float cons70 = float(0.950000);
uniform vec4 unf73;
varying vec3 varposition;
uniform vec3 unf80;
const float cons84 = float(20.000000);
uniform vec3 unf87;
const float cons90 = float(0.996195);
const float cons91 = float(0.000571);
const float cons102 = float(0.950000);
uniform sampler2DShadow samp1;
uniform mat4 unf106;
const float cons107 = float(0.005000);
uniform float unf112;
uniform vec3 unf119;
const float cons123 = float(20.000000);
uniform vec3 unf126;
const float cons129 = float(0.996195);
const float cons130 = float(0.000571);
const float cons141 = float(0.950000);
uniform sampler2DShadow samp2;
uniform mat4 unf145;
const float cons146 = float(0.005000);
uniform float unf151;
...
void main(void)
{
	...
	vcol_attribute(var0, tmp4);
	texco_uv(var1, tmp6);
	mtex_image(tmp6, samp0, tmp9, tmp10, tmp11);
	mtex_alpha_from_col(tmp10, tmp13);
	mtex_value_blend(cons14, cons15, tmp13, cons17, cons18, tmp19);
	mtex_value_clamp(tmp19, tmp21);
	texco_uv(var1, tmp23);
	mtex_image(tmp23, samp0, tmp26, tmp27, tmp28);
	set_rgba(tmp27, tmp30);
	mtex_alpha_from_col(tmp27, tmp32);
	mtex_rgb_mul(tmp4.rgb, tmp30.rgb, tmp32, cons36, tmp37);
	shade_mul_value(cons38, vec4(tmp37, 1.0), tmp40);
	lamp_visibility_sun_hemi(unf41, tmp42, tmp43, tmp44);
	shade_inp(tmp2, tmp42, tmp47);
	shade_is_hemi(tmp47, tmp49);
	shade_visifac(tmp49, tmp44, cons52, tmp53);
	shade_mul_value(tmp53, unf55, tmp56);
	shade_madd(tmp40, tmp56, vec4(tmp37, 1.0), tmp60);
	lamp_visibility_sun_hemi(unf61, tmp62, tmp63, tmp64);
	shade_inp(tmp2, tmp62, tmp67);
	shade_visifac(tmp67, tmp64, cons70, tmp71);
	shade_mul_value(tmp71, unf73, tmp74);
	shade_madd(tmp60, tmp74, vec4(tmp37, 1.0), tmp78);
	lamp_visibility_other(varposition, unf80, tmp81, tmp82, tmp83);
	lamp_falloff_invlinear(cons84, tmp82, tmp86);
	lamp_visibility_spot_circle(unf87, tmp81, tmp89);
	lamp_visibility_spot(cons90, cons91, tmp89, tmp86, tmp94);
	lamp_visibility_clamp(tmp94, tmp96);
	shade_inp(tmp2, tmp81, tmp99);
	shade_visifac(tmp99, tmp96, cons102, tmp103);
	test_shadowbuf(varposition, samp1, unf106, cons107, tmp99, tmp109);
	shade_only_shadow(tmp103, tmp109, unf112, tmp113);
	shade_only_shadow_diffuse(tmp113, tmp37, tmp78, tmp117);
	lamp_visibility_other(varposition, unf119, tmp120, tmp121, tmp122);
	lamp_falloff_invlinear(cons123, tmp121, tmp125);
	lamp_visibility_spot_circle(unf126, tmp120, tmp128);
	lamp_visibility_spot(cons129, cons130, tmp128, tmp125, tmp133);
	lamp_visibility_clamp(tmp133, tmp135);
	shade_inp(tmp2, tmp120, tmp138);
	shade_visifac(tmp138, tmp135, cons141, tmp142);
	test_shadowbuf(varposition, samp2, unf145, cons146, tmp138, tmp148);
	shade_only_shadow(tmp142, tmp148, unf151, tmp152);
	shade_only_shadow_diffuse(tmp152, tmp37, tmp117, tmp156);
	mtex_alpha_to_col(tmp156, tmp21, tmp159);
