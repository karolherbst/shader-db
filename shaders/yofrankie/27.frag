...
const vec3 cons15 = vec3(0.800000, 0.397470, 0.000000);
const float cons18 = float(1.000000);
uniform sampler2D samp1;
varying vec3 var1;
uniform vec3 unf35;
const float cons46 = float(0.680946);
uniform vec4 unf49;
uniform sampler1D samp2;
const float cons62 = float(0.700000);
const float cons75 = float(0.200000);
const float cons76 = float(35.000000);
uniform vec3 unf80;
const vec3 cons81 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf86;
const float cons95 = float(0.680946);
uniform vec4 unf98;
uniform sampler1D samp3;
const float cons111 = float(0.700000);
const float cons124 = float(35.000000);
const float cons126 = float(1.000000);
const float cons127 = float(0.200000);
uniform vec3 unf132;
const vec3 cons133 = vec3(1.000000, 1.000000, 1.000000);
const float cons142 = float(1.000000);
const float cons145 = float(6.000000);
const float cons146 = float(26.000000);
const float cons147 = float(0.000000);
const float cons148 = float(0.000000);
const vec4 cons152 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	set_rgb_zero(tmp33);
	set_rgb_zero(tmp34);
	lamp_visibility_sun_hemi(unf35, tmp36, tmp37, tmp38);
	shade_inp(tmp32, tmp36, tmp41);
	shade_is_hemi(tmp41, tmp43);
	shade_visifac(tmp43, tmp38, cons46, tmp47);
	shade_mul_value(tmp47, unf49, tmp50);
	vec_math_dot(tmp4, tmp32, tmp53, tmp54);
	valtorgb(tmp54, samp2, tmp57, tmp58);
	mtex_alpha_from_col(tmp57, tmp60);
	math_multiply(tmp60, cons62, tmp63);
	mix_blend(tmp63, vec4(tmp19, 1.0), tmp57, tmp67);
	shade_madd(vec4(tmp33, 1.0), tmp50, tmp67, tmp71);
	shade_hemi_spec(tmp32, tmp36, tmp4, cons75, cons76, tmp38, tmp78);
	shade_add_spec(tmp78, unf80, cons81, tmp82);
	shade_add(vec4(tmp34, 1.0), vec4(tmp82, 1.0), tmp85);
	lamp_visibility_sun_hemi(unf86, tmp87, tmp88, tmp89);
	shade_inp(tmp32, tmp87, tmp92);
	shade_visifac(tmp92, tmp89, cons95, tmp96);
	shade_mul_value(tmp96, unf98, tmp99);
	vec_math_dot(tmp4, tmp32, tmp102, tmp103);
	valtorgb(tmp103, samp3, tmp106, tmp107);
	mtex_alpha_from_col(tmp106, tmp109);
	math_multiply(tmp109, cons111, tmp112);
	mix_blend(tmp112, vec4(tmp19, 1.0), tmp106, tmp116);
	shade_madd(tmp71, tmp99, tmp116, tmp120);
	shade_phong_spec(tmp32, tmp87, tmp4, cons124, tmp125);
	shade_spec_t(cons126, cons127, tmp89, tmp125, tmp130);
	shade_add_spec(tmp130, unf132, cons133, tmp134);
	shade_add(tmp85, vec4(tmp134, 1.0), tmp137);
	shade_add(tmp120, tmp137, tmp140);
	mtex_alpha_to_col(tmp140, cons142, tmp143);
	shade_mist_factor(varposition, cons145, cons146, cons147, cons148, tmp149);
	mix_blend(tmp149, tmp143, cons152, tmp153);
	shade_alpha_opaque(tmp153, tmp155);
