...
const vec3 cons14 = vec3(0.689039, 0.652052, 0.417800);
...
const float cons62 = float(6.000000);
const float cons63 = float(26.000000);
const float cons64 = float(0.000000);
const float cons65 = float(0.000000);
const vec4 cons69 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	shade_mist_factor(varposition, cons62, cons63, cons64, cons65, tmp66);
	mix_blend(tmp66, tmp60, cons69, tmp70);
	shade_alpha_opaque(tmp70, tmp72);
