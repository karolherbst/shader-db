...
const vec3 cons16 = vec3(0.800000, 0.800000, 0.800000);
const float cons19 = float(1.000000);
uniform sampler2D samp1;
varying vec3 var1;
uniform vec3 unf33;
const float cons44 = float(0.800000);
uniform vec4 unf47;
uniform vec3 unf53;
const float cons64 = float(1.000000);
const float cons68 = float(0.800000);
uniform vec4 unf71;
uniform vec3 unf78;
const float cons82 = float(20.000000);
uniform vec3 unf85;
const float cons88 = float(0.996195);
const float cons89 = float(0.000571);
const float cons102 = float(1.000000);
const float cons106 = float(0.800000);
uniform sampler2DShadow samp2;
uniform mat4 unf110;
const float cons111 = float(0.005000);
uniform float unf116;
uniform vec3 unf123;
const float cons127 = float(20.000000);
uniform vec3 unf130;
const float cons133 = float(0.996195);
const float cons134 = float(0.000571);
const float cons147 = float(1.000000);
const float cons151 = float(0.800000);
uniform sampler2DShadow samp3;
uniform mat4 unf155;
const float cons156 = float(0.005000);
uniform float unf161;
const float cons168 = float(1.000000);
const float cons171 = float(6.000000);
const float cons172 = float(26.000000);
const float cons173 = float(0.000000);
const float cons174 = float(0.000000);
const vec4 cons178 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	mtex_alpha_from_col(tmp10, tmp15);
	mtex_rgb_blend(cons16, tmp13.rgb, tmp15, cons19, tmp20);
	texco_uv(var0, tmp22);
	mtex_image(tmp22, samp1, tmp25, tmp26, tmp27);
	mtex_nspace_tangent(var1, tmp2, tmp27, tmp31);
	set_rgb_zero(tmp32);
	lamp_visibility_sun_hemi(unf33, tmp34, tmp35, tmp36);
	shade_inp(tmp31, tmp34, tmp39);
	shade_is_hemi(tmp39, tmp41);
	shade_visifac(tmp41, tmp36, cons44, tmp45);
	shade_mul_value(tmp45, unf47, tmp48);
	shade_madd(vec4(tmp32, 1.0), tmp48, vec4(tmp20, 1.0), tmp52);
	lamp_visibility_sun_hemi(unf53, tmp54, tmp55, tmp56);
	shade_inp(tmp31, tmp54, tmp59);
	shade_diffuse_oren_nayer(tmp59, tmp31, tmp54, tmp4, cons64, tmp65);
	shade_visifac(tmp65, tmp56, cons68, tmp69);
	shade_mul_value(tmp69, unf71, tmp72);
	shade_madd(tmp52, tmp72, vec4(tmp20, 1.0), tmp76);
	lamp_visibility_other(varposition, unf78, tmp79, tmp80, tmp81);
	lamp_falloff_invlinear(cons82, tmp80, tmp84);
	lamp_visibility_spot_circle(unf85, tmp79, tmp87);
	lamp_visibility_spot(cons88, cons89, tmp87, tmp84, tmp92);
	lamp_visibility_clamp(tmp92, tmp94);
	shade_inp(tmp31, tmp79, tmp97);
	shade_diffuse_oren_nayer(tmp97, tmp31, tmp79, tmp4, cons102, tmp103);
	shade_visifac(tmp103, tmp94, cons106, tmp107);
	test_shadowbuf(varposition, samp2, unf110, cons111, tmp97, tmp113);
	shade_only_shadow(tmp107, tmp113, unf116, tmp117);
	shade_only_shadow_diffuse(tmp117, tmp20, tmp76, tmp121);
	lamp_visibility_other(varposition, unf123, tmp124, tmp125, tmp126);
	lamp_falloff_invlinear(cons127, tmp125, tmp129);
	lamp_visibility_spot_circle(unf130, tmp124, tmp132);
	lamp_visibility_spot(cons133, cons134, tmp132, tmp129, tmp137);
	lamp_visibility_clamp(tmp137, tmp139);
	shade_inp(tmp31, tmp124, tmp142);
	shade_diffuse_oren_nayer(tmp142, tmp31, tmp124, tmp4, cons147, tmp148);
	shade_visifac(tmp148, tmp139, cons151, tmp152);
	test_shadowbuf(varposition, samp3, unf155, cons156, tmp142, tmp158);
	shade_only_shadow(tmp152, tmp158, unf161, tmp162);
	shade_only_shadow_diffuse(tmp162, tmp20, tmp121, tmp166);
	mtex_alpha_to_col(tmp166, cons168, tmp169);
	shade_mist_factor(varposition, cons171, cons172, cons173, cons174, tmp175);
	mix_blend(tmp175, tmp169, cons178, tmp179);
	shade_alpha_opaque(tmp179, tmp181);
