...
varying vec2 var0;
const vec3 cons6 = vec3(5.000000, 1.000000, 1.000000);
const vec3 cons9 = vec3(-2.000000, 0.000000, 0.000000);
uniform sampler2D samp0;
const float cons18 = float(0.000000);
const float cons19 = float(1.000000);
const float cons21 = float(1.000000);
const float cons22 = float(0.000000);
const vec3 cons29 = vec3(5.000000, 1.000000, 1.000000);
const vec3 cons32 = vec3(-2.000000, 0.000000, 0.000000);
const vec3 cons43 = vec3(0.752822, 0.580422, 0.376056);
const float cons46 = float(1.000000);
const vec3 cons51 = vec3(5.000000, 1.000000, 1.000000);
const vec3 cons54 = vec3(-2.000000, 0.000000, 0.000000);
uniform sampler2D samp1;
varying vec3 var1;
const float cons65 = float(0.450000);
uniform vec3 unf68;
...
const float cons122 = float(1.000000);
varying vec3 varposition;
uniform vec3 unf133;
const float cons137 = float(20.000000);
uniform vec3 unf140;
const float cons143 = float(0.996195);
const float cons144 = float(0.000571);
const float cons155 = float(1.000000);
uniform sampler2DShadow samp4;
uniform mat4 unf159;
const float cons160 = float(0.005000);
uniform float unf165;
uniform vec3 unf172;
const float cons176 = float(20.000000);
uniform vec3 unf179;
const float cons182 = float(0.996195);
const float cons183 = float(0.000571);
const float cons194 = float(1.000000);
uniform sampler2DShadow samp5;
uniform mat4 unf198;
const float cons199 = float(0.005000);
uniform float unf204;
uniform vec4 unfobcolor;
const float cons217 = float(6.000000);
const float cons218 = float(26.000000);
const float cons219 = float(0.000000);
const float cons220 = float(0.000000);
const vec4 cons224 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	texco_uv(var0, tmp4);
	mtex_mapping_size(tmp4, cons6, tmp7);
	mtex_mapping_ofs(tmp7, cons9, tmp10);
	mtex_image(tmp10, samp0, tmp13, tmp14, tmp15);
	mtex_alpha_from_col(tmp14, tmp17);
	mtex_value_blend(cons18, cons19, tmp17, cons21, cons22, tmp23);
	mtex_value_clamp(tmp23, tmp25);
	texco_uv(var0, tmp27);
	mtex_mapping_size(tmp27, cons29, tmp30);
	mtex_mapping_ofs(tmp30, cons32, tmp33);
	mtex_image(tmp33, samp0, tmp36, tmp37, tmp38);
	set_rgba(tmp37, tmp40);
	mtex_alpha_from_col(tmp37, tmp42);
	mtex_rgb_mul(cons43, tmp40.rgb, tmp42, cons46, tmp47);
	texco_uv(var0, tmp49);
	mtex_mapping_size(tmp49, cons51, tmp52);
	mtex_mapping_ofs(tmp52, cons54, tmp55);
	mtex_image(tmp55, samp1, tmp58, tmp59, tmp60);
	mtex_nspace_tangent(var1, tmp2, tmp60, tmp64);
	shade_mul_value(cons65, vec4(tmp47, 1.0), tmp67);
	lamp_visibility_sun_hemi(unf68, tmp69, tmp70, tmp71);
	shade_inp(tmp64, tmp69, tmp74);
	shade_is_hemi(tmp74, tmp76);
	shade_visifac(tmp76, tmp71, cons79, tmp80);
	shade_mul_value(tmp80, unf82, tmp83);
	valtorgb(tmp76, samp2, tmp86, tmp87);
	mtex_alpha_from_col(tmp86, tmp89);
	math_multiply(tmp89, cons91, tmp92);
	mix_blend(tmp92, vec4(tmp47, 1.0), tmp86, tmp96);
	shade_madd(tmp67, tmp83, tmp96, tmp100);
	lamp_visibility_sun_hemi(unf101, tmp102, tmp103, tmp104);
	shade_inp(tmp64, tmp102, tmp107);
	shade_visifac(tmp107, tmp104, cons110, tmp111);
	shade_mul_value(tmp111, unf113, tmp114);
	valtorgb(tmp107, samp3, tmp117, tmp118);
	mtex_alpha_from_col(tmp117, tmp120);
	math_multiply(tmp120, cons122, tmp123);
	mix_blend(tmp123, vec4(tmp47, 1.0), tmp117, tmp127);
	shade_madd(tmp100, tmp114, tmp127, tmp131);
	lamp_visibility_other(varposition, unf133, tmp134, tmp135, tmp136);
	lamp_falloff_invlinear(cons137, tmp135, tmp139);
	lamp_visibility_spot_circle(unf140, tmp134, tmp142);
	lamp_visibility_spot(cons143, cons144, tmp142, tmp139, tmp147);
	lamp_visibility_clamp(tmp147, tmp149);
	shade_inp(tmp64, tmp134, tmp152);
	shade_visifac(tmp152, tmp149, cons155, tmp156);
	test_shadowbuf(varposition, samp4, unf159, cons160, tmp152, tmp162);
	shade_only_shadow(tmp156, tmp162, unf165, tmp166);
	shade_only_shadow_diffuse(tmp166, tmp47, tmp131, tmp170);
	lamp_visibility_other(varposition, unf172, tmp173, tmp174, tmp175);
	lamp_falloff_invlinear(cons176, tmp174, tmp178);
	lamp_visibility_spot_circle(unf179, tmp173, tmp181);
	lamp_visibility_spot(cons182, cons183, tmp181, tmp178, tmp186);
	lamp_visibility_clamp(tmp186, tmp188);
	shade_inp(tmp64, tmp173, tmp191);
	shade_visifac(tmp191, tmp188, cons194, tmp195);
	test_shadowbuf(varposition, samp5, unf198, cons199, tmp191, tmp201);
	shade_only_shadow(tmp195, tmp201, unf204, tmp205);
	shade_only_shadow_diffuse(tmp205, tmp47, tmp170, tmp209);
	mtex_alpha_to_col(tmp209, tmp25, tmp212);
	shade_obcolor(tmp212, unfobcolor, tmp215);
	shade_mist_factor(varposition, cons217, cons218, cons219, cons220, tmp221);
	mix_blend(tmp221, tmp215, cons224, tmp225);
	shade_alpha_obcolor(tmp225, unfobcolor, tmp228);
