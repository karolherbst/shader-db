...
varying vec3 var1;
uniform vec3 unf32;
const float cons43 = float(0.500000);
uniform vec4 unf46;
uniform sampler1D samp2;
const float cons59 = float(0.700000);
uniform vec3 unf69;
const float cons80 = float(1.000000);
const float cons84 = float(0.500000);
uniform vec4 unf87;
uniform sampler1D samp3;
const float cons100 = float(0.700000);
uniform vec3 unf111;
const float cons115 = float(20.000000);
uniform vec3 unf118;
const float cons121 = float(0.996195);
const float cons122 = float(0.000571);
const float cons135 = float(1.000000);
const float cons139 = float(0.500000);
uniform sampler2DShadow samp4;
uniform mat4 unf143;
const float cons144 = float(0.005000);
uniform float unf149;
uniform vec3 unf156;
const float cons160 = float(20.000000);
uniform vec3 unf163;
const float cons166 = float(0.996195);
const float cons167 = float(0.000571);
const float cons180 = float(1.000000);
const float cons184 = float(0.500000);
uniform sampler2DShadow samp5;
uniform mat4 unf188;
const float cons189 = float(0.005000);
uniform float unf194;
const float cons201 = float(1.000000);
const float cons204 = float(6.000000);
const float cons205 = float(26.000000);
const float cons206 = float(0.000000);
const float cons207 = float(0.000000);
const vec4 cons211 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	set_rgb_zero(tmp31);
	lamp_visibility_sun_hemi(unf32, tmp33, tmp34, tmp35);
	shade_inp(tmp30, tmp33, tmp38);
	shade_is_hemi(tmp38, tmp40);
	shade_visifac(tmp40, tmp35, cons43, tmp44);
	shade_mul_value(tmp44, unf46, tmp47);
	vec_math_dot(tmp4, tmp30, tmp50, tmp51);
	valtorgb(tmp51, samp2, tmp54, tmp55);
	mtex_alpha_from_col(tmp54, tmp57);
	math_multiply(tmp57, cons59, tmp60);
	mix_overlay(tmp60, vec4(tmp19, 1.0), tmp54, tmp64);
	shade_madd(vec4(tmp31, 1.0), tmp47, tmp64, tmp68);
	lamp_visibility_sun_hemi(unf69, tmp70, tmp71, tmp72);
	shade_inp(tmp30, tmp70, tmp75);
	shade_diffuse_oren_nayer(tmp75, tmp30, tmp70, tmp4, cons80, tmp81);
	shade_visifac(tmp81, tmp72, cons84, tmp85);
	shade_mul_value(tmp85, unf87, tmp88);
	vec_math_dot(tmp4, tmp30, tmp91, tmp92);
	valtorgb(tmp92, samp3, tmp95, tmp96);
	mtex_alpha_from_col(tmp95, tmp98);
	math_multiply(tmp98, cons100, tmp101);
	mix_overlay(tmp101, vec4(tmp19, 1.0), tmp95, tmp105);
	shade_madd(tmp68, tmp88, tmp105, tmp109);
	lamp_visibility_other(varposition, unf111, tmp112, tmp113, tmp114);
	lamp_falloff_invlinear(cons115, tmp113, tmp117);
	lamp_visibility_spot_circle(unf118, tmp112, tmp120);
	lamp_visibility_spot(cons121, cons122, tmp120, tmp117, tmp125);
	lamp_visibility_clamp(tmp125, tmp127);
	shade_inp(tmp30, tmp112, tmp130);
	shade_diffuse_oren_nayer(tmp130, tmp30, tmp112, tmp4, cons135, tmp136);
	shade_visifac(tmp136, tmp127, cons139, tmp140);
	test_shadowbuf(varposition, samp4, unf143, cons144, tmp130, tmp146);
	shade_only_shadow(tmp140, tmp146, unf149, tmp150);
	shade_only_shadow_diffuse(tmp150, tmp19, tmp109, tmp154);
	lamp_visibility_other(varposition, unf156, tmp157, tmp158, tmp159);
	lamp_falloff_invlinear(cons160, tmp158, tmp162);
	lamp_visibility_spot_circle(unf163, tmp157, tmp165);
	lamp_visibility_spot(cons166, cons167, tmp165, tmp162, tmp170);
	lamp_visibility_clamp(tmp170, tmp172);
	shade_inp(tmp30, tmp157, tmp175);
	shade_diffuse_oren_nayer(tmp175, tmp30, tmp157, tmp4, cons180, tmp181);
	shade_visifac(tmp181, tmp172, cons184, tmp185);
	test_shadowbuf(varposition, samp5, unf188, cons189, tmp175, tmp191);
	shade_only_shadow(tmp185, tmp191, unf194, tmp195);
	shade_only_shadow_diffuse(tmp195, tmp19, tmp154, tmp199);
	mtex_alpha_to_col(tmp199, cons201, tmp202);
	shade_mist_factor(varposition, cons204, cons205, cons206, cons207, tmp208);
	mix_blend(tmp208, tmp202, cons211, tmp212);
	shade_alpha_opaque(tmp212, tmp214);
