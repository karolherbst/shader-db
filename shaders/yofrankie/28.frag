...
const vec3 cons14 = vec3(0.800000, 0.800000, 0.800000);
const float cons16 = float(1.000000);
const float cons17 = float(1.000000);
const float cons21 = float(0.000000);
const float cons22 = float(1.000000);
const float cons24 = float(1.000000);
const float cons25 = float(0.000000);
const float cons29 = float(0.100000);
uniform vec3 unf33;
const float cons44 = float(1.000000);
uniform vec4 unf47;
const float cons56 = float(0.240000);
const float cons57 = float(40.000000);
uniform vec3 unf61;
const vec3 cons62 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf67;
const float cons76 = float(1.000000);
uniform vec4 unf79;
const float cons88 = float(40.000000);
const float cons90 = float(1.000000);
const float cons91 = float(0.240000);
uniform vec3 unf96;
const vec3 cons97 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf103;
const float cons107 = float(20.000000);
uniform vec3 unf110;
const float cons113 = float(0.996195);
const float cons114 = float(0.000571);
const float cons125 = float(1.000000);
uniform sampler2DShadow samp1;
uniform mat4 unf129;
const float cons130 = float(0.005000);
uniform float unf135;
uniform vec3 unf142;
const float cons146 = float(20.000000);
uniform vec3 unf149;
const float cons152 = float(0.996195);
const float cons153 = float(0.000571);
const float cons164 = float(1.000000);
uniform sampler2DShadow samp2;
uniform mat4 unf168;
const float cons169 = float(0.005000);
uniform float unf174;
const float cons187 = float(6.000000);
const float cons188 = float(26.000000);
const float cons189 = float(0.000000);
const float cons190 = float(0.000000);
const vec4 cons194 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	mtex_rgb_blend(cons14, tmp13.rgb, cons16, cons17, tmp18);
	mtex_alpha_from_col(tmp10, tmp20);
	mtex_value_blend(cons21, cons22, tmp20, cons24, cons25, tmp26);
	mtex_value_clamp(tmp26, tmp28);
	shade_mul_value(cons29, vec4(tmp18, 1.0), tmp31);
	set_rgb_zero(tmp32);
	lamp_visibility_sun_hemi(unf33, tmp34, tmp35, tmp36);
	shade_inp(tmp2, tmp34, tmp39);
	shade_is_hemi(tmp39, tmp41);
	shade_visifac(tmp41, tmp36, cons44, tmp45);
	shade_mul_value(tmp45, unf47, tmp48);
	shade_madd(tmp31, tmp48, vec4(tmp18, 1.0), tmp52);
	shade_hemi_spec(tmp2, tmp34, tmp4, cons56, cons57, tmp36, tmp59);
	shade_add_spec(tmp59, unf61, cons62, tmp63);
	shade_add(vec4(tmp32, 1.0), vec4(tmp63, 1.0), tmp66);
	lamp_visibility_sun_hemi(unf67, tmp68, tmp69, tmp70);
	shade_inp(tmp2, tmp68, tmp73);
	shade_visifac(tmp73, tmp70, cons76, tmp77);
	shade_mul_value(tmp77, unf79, tmp80);
	shade_madd(tmp52, tmp80, vec4(tmp18, 1.0), tmp84);
	shade_phong_spec(tmp2, tmp68, tmp4, cons88, tmp89);
	shade_spec_t(cons90, cons91, tmp70, tmp89, tmp94);
	shade_add_spec(tmp94, unf96, cons97, tmp98);
	shade_add(tmp66, vec4(tmp98, 1.0), tmp101);
	lamp_visibility_other(varposition, unf103, tmp104, tmp105, tmp106);
	lamp_falloff_invlinear(cons107, tmp105, tmp109);
	lamp_visibility_spot_circle(unf110, tmp104, tmp112);
	lamp_visibility_spot(cons113, cons114, tmp112, tmp109, tmp117);
	lamp_visibility_clamp(tmp117, tmp119);
	shade_inp(tmp2, tmp104, tmp122);
	shade_visifac(tmp122, tmp119, cons125, tmp126);
	test_shadowbuf(varposition, samp1, unf129, cons130, tmp122, tmp132);
	shade_only_shadow(tmp126, tmp132, unf135, tmp136);
	shade_only_shadow_diffuse(tmp136, tmp18, tmp84, tmp140);
	lamp_visibility_other(varposition, unf142, tmp143, tmp144, tmp145);
	lamp_falloff_invlinear(cons146, tmp144, tmp148);
	lamp_visibility_spot_circle(unf149, tmp143, tmp151);
	lamp_visibility_spot(cons152, cons153, tmp151, tmp148, tmp156);
	lamp_visibility_clamp(tmp156, tmp158);
	shade_inp(tmp2, tmp143, tmp161);
	shade_visifac(tmp161, tmp158, cons164, tmp165);
	test_shadowbuf(varposition, samp2, unf168, cons169, tmp161, tmp171);
	shade_only_shadow(tmp165, tmp171, unf174, tmp175);
	shade_only_shadow_diffuse(tmp175, tmp18, tmp140, tmp179);
	shade_add(tmp179, tmp101, tmp182);
	mtex_alpha_to_col(tmp182, tmp28, tmp185);
	shade_mist_factor(varposition, cons187, cons188, cons189, cons190, tmp191);
	mix_blend(tmp191, tmp185, cons194, tmp195);
