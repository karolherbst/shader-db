...
const vec4 cons1 = vec4(1.000000, 0.601893, 0.341876, 0.000000);
const float cons2 = float(0.200000);
varying vec3 varposition;
const float cons5 = float(6.000000);
const float cons6 = float(26.000000);
const float cons7 = float(0.000000);
const float cons8 = float(0.000000);
const vec4 cons12 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	mtex_alpha_to_col(cons1, cons2, tmp3);
	shade_mist_factor(varposition, cons5, cons6, cons7, cons8, tmp9);
	mix_blend(tmp9, tmp3, cons12, tmp13);
