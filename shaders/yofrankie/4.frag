...
uniform vec3 unf4;
const float cons15 = float(0.400000);
uniform vec4 unf18;
const vec4 cons22 = vec4(0.800000, 0.800000, 0.800000, 0.000000);
uniform vec3 unf24;
const float cons33 = float(0.400000);
uniform vec4 unf36;
const vec4 cons40 = vec4(0.800000, 0.800000, 0.800000, 0.000000);
varying vec3 varposition;
uniform vec3 unf43;
const float cons47 = float(20.000000);
uniform vec3 unf50;
const float cons53 = float(0.996195);
const float cons54 = float(0.000571);
const float cons65 = float(0.400000);
uniform sampler2DShadow samp0;
uniform mat4 unf69;
const float cons70 = float(0.005000);
uniform float unf75;
const vec3 cons78 = vec3(0.800000, 0.800000, 0.800000);
uniform vec3 unf82;
const float cons86 = float(20.000000);
uniform vec3 unf89;
const float cons92 = float(0.996195);
const float cons93 = float(0.000571);
const float cons104 = float(0.400000);
uniform sampler2DShadow samp1;
uniform mat4 unf108;
const float cons109 = float(0.005000);
uniform float unf114;
const vec3 cons117 = vec3(0.800000, 0.800000, 0.800000);
const float cons121 = float(1.000000);
const float cons124 = float(6.000000);
const float cons125 = float(26.000000);
const float cons126 = float(0.000000);
const float cons127 = float(0.000000);
const vec4 cons131 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	set_rgb_zero(tmp3);
	lamp_visibility_sun_hemi(unf4, tmp5, tmp6, tmp7);
	shade_inp(tmp2, tmp5, tmp10);
	shade_is_hemi(tmp10, tmp12);
	shade_visifac(tmp12, tmp7, cons15, tmp16);
	shade_mul_value(tmp16, unf18, tmp19);
	shade_madd(vec4(tmp3, 1.0), tmp19, cons22, tmp23);
	lamp_visibility_sun_hemi(unf24, tmp25, tmp26, tmp27);
	shade_inp(tmp2, tmp25, tmp30);
	shade_visifac(tmp30, tmp27, cons33, tmp34);
	shade_mul_value(tmp34, unf36, tmp37);
	shade_madd(tmp23, tmp37, cons40, tmp41);
	lamp_visibility_other(varposition, unf43, tmp44, tmp45, tmp46);
	lamp_falloff_invlinear(cons47, tmp45, tmp49);
	lamp_visibility_spot_circle(unf50, tmp44, tmp52);
	lamp_visibility_spot(cons53, cons54, tmp52, tmp49, tmp57);
	lamp_visibility_clamp(tmp57, tmp59);
	shade_inp(tmp2, tmp44, tmp62);
	shade_visifac(tmp62, tmp59, cons65, tmp66);
	test_shadowbuf(varposition, samp0, unf69, cons70, tmp62, tmp72);
	shade_only_shadow(tmp66, tmp72, unf75, tmp76);
	shade_only_shadow_diffuse(tmp76, cons78, tmp41, tmp80);
	lamp_visibility_other(varposition, unf82, tmp83, tmp84, tmp85);
	lamp_falloff_invlinear(cons86, tmp84, tmp88);
	lamp_visibility_spot_circle(unf89, tmp83, tmp91);
	lamp_visibility_spot(cons92, cons93, tmp91, tmp88, tmp96);
	lamp_visibility_clamp(tmp96, tmp98);
	shade_inp(tmp2, tmp83, tmp101);
	shade_visifac(tmp101, tmp98, cons104, tmp105);
	test_shadowbuf(varposition, samp1, unf108, cons109, tmp101, tmp111);
	shade_only_shadow(tmp105, tmp111, unf114, tmp115);
	shade_only_shadow_diffuse(tmp115, cons117, tmp80, tmp119);
	mtex_alpha_to_col(tmp119, cons121, tmp122);
	shade_mist_factor(varposition, cons124, cons125, cons126, cons127, tmp128);
	mix_blend(tmp128, tmp122, cons131, tmp132);
	shade_alpha_opaque(tmp132, tmp134);
