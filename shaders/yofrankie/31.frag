...
uniform vec3 unf7;
const float cons18 = float(0.800000);
uniform vec4 unf21;
const vec4 cons25 = vec4(0.000000, 1.000000, 1.000000, 0.000000);
const float cons30 = float(0.500000);
const float cons31 = float(50.000000);
uniform vec3 unf35;
const vec3 cons36 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf41;
const float cons50 = float(0.800000);
uniform vec4 unf53;
const vec4 cons57 = vec4(0.000000, 1.000000, 1.000000, 0.000000);
const float cons62 = float(50.000000);
const float cons64 = float(1.000000);
const float cons65 = float(0.500000);
uniform vec3 unf70;
const vec3 cons71 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf77;
const float cons81 = float(20.000000);
uniform vec3 unf84;
const float cons87 = float(0.996195);
const float cons88 = float(0.000571);
const float cons99 = float(0.800000);
uniform sampler2DShadow samp0;
uniform mat4 unf103;
const float cons104 = float(0.005000);
uniform float unf109;
const vec3 cons112 = vec3(0.000000, 1.000000, 1.000000);
uniform vec3 unf116;
const float cons120 = float(20.000000);
uniform vec3 unf123;
const float cons126 = float(0.996195);
const float cons127 = float(0.000571);
const float cons138 = float(0.800000);
uniform sampler2DShadow samp1;
uniform mat4 unf142;
const float cons143 = float(0.005000);
uniform float unf148;
const vec3 cons151 = vec3(0.000000, 1.000000, 1.000000);
const float cons158 = float(1.000000);
const float cons161 = float(6.000000);
const float cons162 = float(26.000000);
const float cons163 = float(0.000000);
const float cons164 = float(0.000000);
const vec4 cons168 = vec4(0.906274, 0.882745, 0.992157, 0.000000);
...
void main(void)
{
	...
	shade_is_hemi(tmp13, tmp15);
	shade_visifac(tmp15, tmp10, cons18, tmp19);
	shade_mul_value(tmp19, unf21, tmp22);
	shade_madd(vec4(tmp5, 1.0), tmp22, cons25, tmp26);
	shade_hemi_spec(tmp2, tmp8, tmp4, cons30, cons31, tmp10, tmp33);
	shade_add_spec(tmp33, unf35, cons36, tmp37);
	shade_add(vec4(tmp6, 1.0), vec4(tmp37, 1.0), tmp40);
	lamp_visibility_sun_hemi(unf41, tmp42, tmp43, tmp44);
	shade_inp(tmp2, tmp42, tmp47);
	shade_visifac(tmp47, tmp44, cons50, tmp51);
	shade_mul_value(tmp51, unf53, tmp54);
	shade_madd(tmp26, tmp54, cons57, tmp58);
	shade_cooktorr_spec(tmp2, tmp42, tmp4, cons62, tmp63);
	shade_spec_t(cons64, cons65, tmp44, tmp63, tmp68);
	shade_add_spec(tmp68, unf70, cons71, tmp72);
	shade_add(tmp40, vec4(tmp72, 1.0), tmp75);
	lamp_visibility_other(varposition, unf77, tmp78, tmp79, tmp80);
	lamp_falloff_invlinear(cons81, tmp79, tmp83);
	lamp_visibility_spot_circle(unf84, tmp78, tmp86);
	lamp_visibility_spot(cons87, cons88, tmp86, tmp83, tmp91);
	lamp_visibility_clamp(tmp91, tmp93);
	shade_inp(tmp2, tmp78, tmp96);
	shade_visifac(tmp96, tmp93, cons99, tmp100);
	test_shadowbuf(varposition, samp0, unf103, cons104, tmp96, tmp106);
	shade_only_shadow(tmp100, tmp106, unf109, tmp110);
	shade_only_shadow_diffuse(tmp110, cons112, tmp58, tmp114);
	lamp_visibility_other(varposition, unf116, tmp117, tmp118, tmp119);
	lamp_falloff_invlinear(cons120, tmp118, tmp122);
	lamp_visibility_spot_circle(unf123, tmp117, tmp125);
	lamp_visibility_spot(cons126, cons127, tmp125, tmp122, tmp130);
	lamp_visibility_clamp(tmp130, tmp132);
	shade_inp(tmp2, tmp117, tmp135);
	shade_visifac(tmp135, tmp132, cons138, tmp139);
	test_shadowbuf(varposition, samp1, unf142, cons143, tmp135, tmp145);
	shade_only_shadow(tmp139, tmp145, unf148, tmp149);
	shade_only_shadow_diffuse(tmp149, cons151, tmp114, tmp153);
	shade_add(tmp153, tmp75, tmp156);
	mtex_alpha_to_col(tmp156, cons158, tmp159);
	shade_mist_factor(varposition, cons161, cons162, cons163, cons164, tmp165);
	mix_blend(tmp165, tmp159, cons168, tmp169);
	shade_alpha_opaque(tmp169, tmp171);
