...
uniform vec4 unf18;
const vec4 cons22 = vec4(1.000000, 1.000000, 1.000000, 0.000000);
uniform vec3 unf24;
const float cons33 = float(0.400000);
uniform vec4 unf36;
const vec4 cons40 = vec4(1.000000, 1.000000, 1.000000, 0.000000);
...
uniform float unf75;
const vec3 cons78 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf82;
